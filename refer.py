...
# 將資料放進空間
textTrain = open(os.path.join("Data/hw1_data/train.csv"), "r", encoding="big5")
...
listTestData = []
textTest = open(os.path.join("Data/hw1_data/test.csv"), "r", encoding="big5")
...
arrayW_gd, listCost_gd = GD(X=arrayTrainX, Y=arrayTrainY, W=arrayW, eta=intLearningRate, Iteration=10000, lambdaL2=0)
print(listCost_gd)
arrayW = np.zeros(arrayTrainX.shape[1])  # (163, )
